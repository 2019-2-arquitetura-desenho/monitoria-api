...
ALLOWED_HOSTS = ['fga-monitoria-api.herokuapp.com']
...
EMAIL_PORT = 587
EMAIL_HOST_USER = 'monitoriafga1@gmail.com'
...
TEMPLATES = [
    {
        ...
        'libraries':{
            ...
            'get_Front_link': 'monitoria.templatetags.poll_extras',
            }
        },
    },
]
